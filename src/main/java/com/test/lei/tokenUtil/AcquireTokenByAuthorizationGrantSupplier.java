...
import com.test.lei.tokenUtil.ClientApplicationBase;
import com.test.lei.tokenUtil.AuthenticationResult;
import com.test.lei.tokenUtil.AuthenticationResultSupplier;
import com.test.lei.tokenUtil.Authority;
import com.test.lei.tokenUtil.AuthorityType;
import com.test.lei.tokenUtil.MsalRequest;
...
/**
 * @description: AcquireTokenByAuthorizationGrantSupplier
 * @author: leiming5
 * @date: 2020-10-09 13:29
 */
public class AcquireTokenByAuthorizationGrantSupplier extends AuthenticationResultSupplier {
    ...
    AuthenticationResult execute() throws Exception {
        ...
        if (authGrant instanceof OAuthAuthorizationGrant) {
            msalRequest.msalAuthorizationGrant = processPasswordGrant((OAuthAuthorizationGrant) authGrant);
        }
